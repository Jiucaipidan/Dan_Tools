...
3.修改父材质（**注意父材质里的参数名称要一致才能替换后修改为一样的**）
界面展示
![请添加图片描述](https://i-blog.csdnimg.cn/direct/3006a9e34af94bf8bf9bbf9d171b0859.png)
材质界面展示（现在有两个材质和一个材质实例，这个材质实例分别以那两个材质为父级）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/e2d37564485f4b26a12d800ff9d46202.png)
![请添加图片描述](https://i-blog.csdnimg.cn/direct/7e67324064a54500a1c29b20b83736a2.png)
选择材质实例和需更改的材质（选择更改纹理参数，开始父级为white，现在改为black）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/12b6dc1d777542aebfcc7b0e160f330d.png)

结果展示（可以看见现在父级为black，但是保留了white的纹理2222）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/8fed777d4d064eb2ab99fc2b327dcb94.png)
现在修改向量参数（black的向量param为黑，white的param为白）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/e844a7fe2504456e9f42153f4adbfb15.png)
结果展示（可以看见父级变成了white，但是param仍然为黑）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/bd7458252a164811b5afe376c53af0c7.png)
4.按材质拆分模型
![请添加图片描述](https://i-blog.csdnimg.cn/direct/9033aa6e99474575b630f6e1acdcab53.png)
拆分模型默认（先选择模型，点击按钮，拆分后的模型在新文件中显示）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/a3485ae5cb3143bf91675ab32f29c392.png)
移入到关卡中（轴默认可以还原拆分前的样子）
...
11.合并actor
合并后不删除选择的模型（首先选择需要合并的模型，输入合并后的名称和选择好Retain保留）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/a833e4ff6e9644ecae4575dd646fab1a.png)
点击合并actor（可以看见大纲里多了个New_Model的模型选择的也成功保留，而且内容浏览器里也创建了文件夹保留这个合并后的模型且模型轴居中）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/acc5db6aafe9418b85eebfdf46f55468.png)

合并后删除选择的模型（选择需合并的模型，输入名称和选择好destroy销毁）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/354658ca252d47d38495812ec6eeb650.png)
点击合并actor（可以看见大纲里之前选择的模型消失了，多了个合并后的模型Mew_Model2，且轴位置居中）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/f33acc2b3c1142fdb6c5ed39b3b90546.png)

12.选择内容（分为选择灯光，空模型和文本）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/7b58b1c8871e4d1c92bc99ed63ef50b0.png)
筛选灯光
![请添加图片描述](https://i-blog.csdnimg.cn/direct/8ad58467f73f44eb828e2e2142df9634.png)
![请添加图片描述](https://i-blog.csdnimg.cn/direct/14f84c277f054dbf9ac20fa182ef57e3.png)
筛选空模型
![请添加图片描述](https://i-blog.csdnimg.cn/direct/e8f1ccaa3c224b208c0f4f3495cb6e30.png)
![请添加图片描述](https://i-blog.csdnimg.cn/direct/8aa667226dd84839bfb868e0fafd039b.png)
按文本筛选
![请添加图片描述](https://i-blog.csdnimg.cn/direct/ff72d1bdbfa2406eafccf798dda96c79.png)
![请添加图片描述](https://i-blog.csdnimg.cn/direct/62c67e2416d845aabee72cb63b238b17.png)
...
14.设置打包分辨率（按自己电脑分辨率自动适配）
界面位置展示
![请添加图片描述](https://i-blog.csdnimg.cn/direct/f59129cce66d42c8b2bc3758e11e990f.png)
先设置好分辨率然后点击设置分辨率，大纲里显示了BP_Resolution后点击新建编辑器视口运行
![请添加图片描述](https://i-blog.csdnimg.cn/direct/f467dd677da345219486f9dee24de500.png)
运行窗口展示（这个窗口就是打包后的默认窗口分辨率）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/894bea698ce94c93b479449e2cca03ff.png)
如果输入的分辨率比自己电脑所支持的最大分辨率大，那么就能自动适配分辨率
比如这里输入的分辨率为2160*720，但是我电脑屏幕最大分辨率为1920*1080，那么最后显示的窗口大小就会按比例适配自己屏幕的分辨率
![请添加图片描述](https://i-blog.csdnimg.cn/direct/ae73d8e6bf424a1897809c485c7b29f9.png)
