...
Download link：[click](https://www.fab.com/zh-cn/listings/d3e344e3-eae0-425d-a38d-4dfa3adc886b)
...
Before use: Please enable ModelingToolsEditorMode and the GeometryScripting plugin
![Insert image description here](https://i-blog.csdnimg.cn/direct/99c2c6d6d1d84b399beea111953c7d21.png)

# 2. How to Run
## 1. Installation Location
Place the plugin in the Content folder under the project directory .

![请添加图片描述](https://i-blog.csdnimg.cn/direct/8692bd61673b42ff9d9806f22b6a515b.png)


## 2. Location in the Engine
![请添加图片描述](https://i-blog.csdnimg.cn/direct/4067419f69d64418a4b90004c366ce88.png)
...
![请添加图片描述](https://i-blog.csdnimg.cn/direct/256098958c20487fb86d56e8c4d780f1.png)
...
![请添加图片描述](https://i-blog.csdnimg.cn/direct/b0176b71ed664882a0847711e552683b.png)
 ...
 1. Modify Parent Material（Modify the related content where the parameter names in the parent material are consistent）
 ![请添加图片描述](https://i-blog.csdnimg.cn/direct/ac267eeb7c894e4b9fc3dfb3296e3286.png)
Interface display of different parent material instances
black
![请添加图片描述](https://i-blog.csdnimg.cn/direct/11fcc7fb1e364670897733a25128af49.png)
white
![请添加图片描述](https://i-blog.csdnimg.cn/direct/ba7802aaf71b439d8f93b7384fb0515a.png)
Change the parent item of the selected material instance from white to black (by modifying the texture parameters)
![请添加图片描述](https://i-blog.csdnimg.cn/direct/608d01e37d4945e4be2bdc2d34675b64.png)
Results Display（The parent level is black, and the texture parameter retains the white value 01 instead of the black value 02）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/7cf8377d29144eb695c3bc8b7bfd1c71.png)
...
![请添加图片描述](https://i-blog.csdnimg.cn/direct/c938241bcfea4c558aaa6e1fe2904293.png)
 ...
 1. Merge actor
 Select the model to be merged, choose "Retain" and enter a name![请添加图片描述](https://i-blog.csdnimg.cn/direct/d14b57bbc9214f4681213b68a85ddc5c.png)
 Results Display（The merged model is generated and processed, while the original models that need to be merged are retained）![请添加图片描述](https://i-blog.csdnimg.cn/direct/780dc90dd20c441c9e63005c112e6ffa.png)
Merge and destroy the model（Select the model to be merged and choose the input name for destruction）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/1b1af3a8923c4cc3a81d98af2774a324.png)
Results Display（The selected model has been destroyed, and a new merged model has been created with the axes centered，and the axis is centered）
![请添加图片描述](https://i-blog.csdnimg.cn/direct/4ae372cd7417447b891086e2364c718d.png)
 12. selection content
 filtered lighting
 ![请添加图片描述](https://i-blog.csdnimg.cn/direct/9b551915956a44449839c6908c65e77c.png)
Filter empty model
![请添加图片描述](https://i-blog.csdnimg.cn/direct/5261d551b3d440b3845233a345761e60.png)
Filter by text
![请添加图片描述](https://i-blog.csdnimg.cn/direct/eecab5d4a08f4e68af5629e478699306.png)
![请添加图片描述](https://i-blog.csdnimg.cn/direct/9b63dc8cc9eb4cc6a51c4bf9711edb10.png)
...
![请添加图片描述](https://i-blog.csdnimg.cn/direct/ca1a520299c045a38879caf0fbc53268.png)
 ...
 14. Set the screen resolution for packaging（It can automatically adapt to the screen resolution for display）
 ![请添加图片描述](https://i-blog.csdnimg.cn/direct/6b8c2940c1444503972bf17cf91a4a05.png)
 
For example, first set the resolution to 1080*1080, then click on "Set Resolution", and BP_Resolution will be generated in the outline. Finally, click on "New Editor Window (PIE)"
![请添加图片描述](https://i-blog.csdnimg.cn/direct/003aae13223740d4bbef21f06635e859.png)
 Interface Display
 ![请添加图片描述](https://i-blog.csdnimg.cn/direct/ddd3b41c8c204386b0a842c06a4963ac.png)
 If the set resolution is greater than the maximum resolution of the screen, it will be automatically adjusted for display (my maximum resolution is 1920*1080, but here it is 2160*720)
![请添加图片描述](https://i-blog.csdnimg.cn/direct/e96a80cfea2c440db82cf1e94ec0b6e1.png)
